# Generated by Django 4.0.4 on 2022-04-30 09:07
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('core', '0002_remove_user_name_user_username'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('conv_unit', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='conv_unit', to='core.unit')),
        ...
        migrations.AddField(
            model_name='state',
            name='created_by',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='state_created_by', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='state',
            name='updated_by',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='state_changed_by', to=settings.AUTH_USER_MODEL),
        ),
        migrations.CreateModel(
            name='MedicinePrice',
            fields=[
        ...
        migrations.AddField(
            model_name='food',
            name='created_by',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='food_created_by', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='food',
            name='food_storage',
        ...
        migrations.AddField(
            ...
            name='created_by',
            field=models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='active_substance_created_by', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='activesubstance',
            name='unit',
